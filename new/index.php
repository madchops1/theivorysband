      ...
      <div class='pagewrapper'>
        <div class='topbar'>
            ...
            <ul class='control-buttons'>
              <li id='ytb-now-playing'>Now Playing:</li>
              <li id='ytb-title'>She Needs the Money</li>
              <li id='ytb-resume'><a href='javascript:void(0);'>Play</a></li>
              <li id='ytb-pause'><a href='javascript:void(0);'>Pause</a></li>
            </ul>
        </div>
        
        
        
        <div class='contentbox-trans'></div>
        <div class='contentbox'>
          <a class='logo-wrapper' href='#'>
            <img id='logo' src='images/trans-logo-wh.png' />
          </a>
          <ul class="socialnav">
              <li class='sharevideo'>
              ...
              <!-- Twitter Share
              <li class='sharevideo2'>
                <a href="https://twitter.com/intent/tweet?url=http%3A%2F%2Fyoutu.be%2FJONFg43WvZQ&text=The+Ivorys+|+She+Needs+The+Money+[HD]%3A&via=youtube&related=Youtube%2CYouTubeTrends%2CYTCreators" onclick="NewWindow(this.href,'Share The Ivorys Video on Twitter!','650','306','no','center');return false" onfocus="this.blur()">Tweet Video</a>
              </li>
              -->
          ...
          <ul class='mainnav'>
            <li><a id='music' class='social' href='http://soundcloud.com/theivorys' target='_blank'>Listen</a></li>
        ...
        <div class='bottombar footer'>
          <div class='copyright'>
            &copy; <?=date(Y) ?> The Ivorys, All Rights Reserved. &nbsp;&nbsp;|&nbsp;&nbsp; <a class='karl' href='http://karlsteltenpohl.com' target='_blank'>Developed by KJS</a>
          </div>
          
          <ul class='social-accounts'>
            <li><a href='http://facebook.com/TheIvorys'>Facebook</a></li>
            <li><a href='http://twitter.com/theivorys'>Twitter</a></li>
            <li><a href='http://www.youtube.com/user/TheIvorys'>YouTube</a></li>
            <li><a href='http://soundcloud.com/theivorys'>SoundCloud</a></li>
            <li><a href='http://open.spotify.com/artist/6ITon1oysmGOeJekhy2SQn'>Spotify</a></li>
            <li><a href='http://click.linksynergy.com/fs-bin/stat?id=eH8NOY8fBFE&offerid=78941&type=3&subid=0&tmpid=1826&RD_PARM1=http%253A%252F%252Fphobos.apple.com%252FWebObjects%252FMZStore.woa%252Fwa%252FviewAlbum%253Fid%253D564643765%2526s%253D143441%2526partnerId%253D30'>iTunes</a></li>
          </ul>
